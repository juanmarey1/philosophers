...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/16 12:17:30 by jrey-roj          #+#    #+#             */
/*   Updated: 2024/09/16 12:17:32 by jrey-roj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_eat_mutex(t_data *data)
{
	data->eat_mutex = (pthread_mutex_t *)malloc(sizeof(pthread_mutex_t)
			* data->philo_num);
	if (!data->eat_mutex)
	{
		free(data->philos);
